...
@Composable
fun HardwareKeyboardTrackingTextField(
    modifier: Modifier = Modifier,
    referenceText: String,
    onKeyLogged: (LoggedKeyEvent) -> Unit
) {
    val viewModel = hiltViewModel<HardwareKeyboardTrackingTextFieldViewModel>()
    ...
    TextField(
        ...
        onValueChange = {
            // I intentionally don't update the value here.
        },
        modifier = modifier
            .onKeyEvent {
                viewModel.processKeyEvent(it)
            }
    )
